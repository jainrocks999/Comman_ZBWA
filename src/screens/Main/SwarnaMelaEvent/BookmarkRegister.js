...
import ScannerIcon from '../../../assets/EventSwarnMela/scannerIcon.svg';
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#F8F8F8'}}>
      ...
      <ScrollView style={{flexGrow: 1, paddingHorizontal: 15}}>
        <Text style={styles.HeadingText}> My Bookmarked Exhibitors</Text>

        <View style={styles.infoDetailSection}>
          <Text style={styles.formTitleheading}>Scan Exhibitor’s QR Code</Text>

          <View style={styles.alignRow}>
            <ScannerIcon />
            <Text style={[styles.cardTitle, {width: '80%'}]}>
              Scan exhibitor’s QR to record your visit 
            </Text>
          </View>
        </View>
        <FlatList
            ...
            <View style={[styles.infoDetailSection, {gap: 10}]}>
              ...
              <View style={styles.alignRow}>
                ...
                <View style={{width: '62%'}}>
                  ...
                  <View style={[styles.alignRow, {flexWrap: 'wrap', gap: 5}]}>
              ...
              <View style={styles.alignRow}>
                ...
                <TouchableOpacity style={{flex: 1}}
                //of temprary
                onPress={()=>navigation.navigate('VisitedExhibitorList')}
                >
                  <LinearGradient
                    colors={['#DDAC17', '#FFFA8A', '#ECC440']}
                    start={{x: 0, y: 0}}
                    ...
                    <InfoIcon />
                    <Text style={styles.formTitleheading}>View Details</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
            </View>
